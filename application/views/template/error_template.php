...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pt" lang="pt">
    <head>
	<title><?php echo __('WeGoAdventures ERRO')?></title>
	<meta name="keywords" content="<?php echo __('')?>"/>
	<meta name="author" content="WeGoAdeventures"/>
	<meta name="robots" content="nofollow,noindex"/>
	<meta name="copyright" content="WeGoAdventures © 2013"/>

	<meta name="language" content="Portuguese"/>
	<meta name="country" content="Portugual"/>
	<meta name="description" content="<?php echo __('WeGoAdventures')?>"/>
        ...
        <div id="main_container">
            ...
            <div id="global_body">
                <div id="error_box">
                    ...
                    <h1><a href="http://www.WeGoAdventures.pt" title="www.WeGoAdventures.pt">www.WeGoAdventures.pt</a></h1>
                </div>
            </div>
